...
Spectra.getLabelForQOP = function(qop) {
    if (qop >= 6) {
...
ProcessorManager.shouldProcess = function(spectra) {
    return !spectra.isProcessing && !spectra.isProcessed;
};
ProcessorManager.shouldMatch = function(spectra) {
    return spectra.isProcessed && !spectra.isMatching && (!spectra.isMatched || spectra.templateResults == null);
};
ProcessorManager.shouldProcessAndMatch = function(spectra) {
    return !spectra.isProcessing && !spectra.isProcessed;
};
...
ResultsGenerator.getStatistics = function(results) {
...
ResultsGenerator.getLocalStorageResult = function(spectra) {
    var result = {};
